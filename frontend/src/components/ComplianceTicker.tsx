...
export const ComplianceTicker = () => {
  ...
  return (
    <section className="py-16 relative overflow-hidden border-y border-white/5 bg-black/20">
      ...
      <div className="relative">
        ...
        >
          {items.map((standard, index) => (
            <div
              key={`${standard}-${index}`}
              className="flex items-center gap-3 glass px-6 py-3 rounded-full whitespace-nowrap group hover:border-sentinel-blue/50 transition-all duration-300 cursor-default"
            >
